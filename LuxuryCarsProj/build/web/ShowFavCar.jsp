...
<html>
    ...
    <body>
      ...
      <center><table bgcolor="white" cellpadding="10" border="1">
            <tr>
                <td>
                    <form name="tofes" method="get" onsubmit="return checkForm()" action="ShowFavCar2.jsp">
                         <select name="FavCars" id="FavCars">
                             <option>not picked</option>
                             <option>Family Cars</option>
                             <option>Compact Cars</option>
                             <option>Mid-size Cars</option>
                             <option>Full-size Cars</option>     
                         </select>
                        <br>
